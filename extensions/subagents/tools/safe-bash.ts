...
const DANGEROUS_PATTERNS = [
	...
	// Prevent wiping the current workspace through common shell forms.
	/\brm\s+[^\n;&|]*-[a-zA-Z]*r[a-zA-Z]*[^\n;&|]*-[a-zA-Z]*f[a-zA-Z]*[^\n;&|]*(?:\.|\.\/|\.\.|\.\.\/|\*)\s*(?:$|[;&|])/,
	/\brm\s+[^\n;&|]*-[a-zA-Z]*f[a-zA-Z]*[^\n;&|]*-[a-zA-Z]*r[a-zA-Z]*[^\n;&|]*(?:\.|\.\/|\.\.|\.\.\/|\*)\s*(?:$|[;&|])/,
	/\bgit\s+clean\s+(?=[^\n;&|]*-[a-zA-Z]*x)(?=[^\n;&|]*-[a-zA-Z]*f)(?=[^\n;&|]*-[a-zA-Z]*d)[^\n;&|]*/,
	/\bsudo\b/,
...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		label: "Safe Bash",
		description:
			"Execute a bash command. Blocks dangerous commands (rm -rf /, rm -rf ., git clean -xfd, sudo, mkfs, etc.).",
